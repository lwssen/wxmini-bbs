...
public class SensitiveWordUtil {
    ...
    public static void main(String[] args) {
        ...
        sensitiveWordSet.add("鸡");
        sensitiveWordSet.add("鸡哥");
        sensitiveWordSet.add("鸡啊");
        sensitiveWordSet.add("鸡儿");
        //初始化敏感词库
        SensitiveWordUtil.init(sensitiveWordSet);

        System.out.println("敏感词的数量：" + SensitiveWordUtil.sensitiveWordMap.size());
        String string = "鸡哥啊啊啊太多的伤感情怀也许只局限于饲养基地 荧幕中的情节鸡鸡鸡鸡零零零零。"
                + "然后我们的扮演的角色就是跟随着主人公aaa鸡啊的喜红客联盟 怒哀乐而过于牵强的把自己的情感也附加于银幕情节中，然后感动就流泪，"
